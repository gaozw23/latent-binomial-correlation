...
manifest <- generate_phase3_stream_files()
dir.create("results/manifests", recursive = TRUE, showWarnings = FALSE)
write.csv(manifest, "results/manifests/phase3_rng_stream_manifest.csv", row.names = FALSE, quote = TRUE)
print(manifest)
cat("Pairwise-simulation RNG stream generation completed in",
